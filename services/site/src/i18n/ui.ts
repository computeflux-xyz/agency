...
export const ui = {
  en: {
    ...
    "whitePapers.gatePromise": "We send the document once, to the address you give us. No drip campaign, no list sharing.",
  ...
  fr: {
    ...
    "whitePapers.gatePromise": "Nous envoyons le document une fois, à l'adresse que vous indiquez. Pas de séquence automatique, pas de revente de fichier.",
